...
const Sidebar = () => {
  return (
    <div className="h-screen w-64 bg-blue-600 text-white fixed flex flex-col justify-between overflow-y-auto">
      <div>
        ...
        <div className="p-4 flex items-center space-x-4 bg-blue-800 rounded-lg shadow-lg">
          ...
          <div>
            ...
            <Link to="/others" className="block py-2.5 px-4 bg-blue-800 hover:bg-blue-700">Contribution & History</Link>
          </div>
        </div>
        <nav className="mt-10">
